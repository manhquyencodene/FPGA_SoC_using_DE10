...
module system_mm_interconnect_0 (
		...
		input  wire        hex4_reset_reset_bridge_in_reset_reset,         //         hex4_reset_reset_bridge_in_reset.reset
	...
	wire   [9:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> hex1_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> hex2_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> hex3_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> hex4_s1_agent:cp_channel
	...
	wire   [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> hex5_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [94:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_011:sink_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clock_clk_clk),                          //                      clk.clk
		.reset                  (hex4_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clock_clk_clk),                            //             clk.clk
		.reset                   (hex4_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clock_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (hex4_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
